      ...
      <div className="sections">
        <section id="hero">
          <div className="left">
            ...
            <span className="largest-boldest">
              Full-Stack Developer and Lifelong Learner.
            </span>

            <p>
              I learn, build, and empower others with my knowledge. Crafting
              robust backend systems and intuitive frontend experiences is my
              passion.
            </p>
          </div>
          <div className="right">
                  ...
                  <div>
                    ...
                    <ul class="space-y-3">
                      <li>
                        ...
                        Dynamic cart system, CRUD ops, Redis caching, JWT auth,
                        Socket.IO real-time communication.
                      </li>
                      <li>
                        <span class="font-semibold">Frontend:</span> React,
                        Next.js, CSS frameworks, Multer & AWS S3 for image
                        uploads.
                      </li>
                      <li>
                        <span class="font-semibold">
                        ...
                        API optimization, Twitter & LinkedIn API integration,
                        Swagger docs.
                      </li>
                      <li>
                        <span class="font-semibold">Push Notifications:</span>{" "}
                        Expo push notifications for enhanced engagement.
                      </li>
                      <li>
                        <span class="font-semibold">Team Leadership:</span> Led
                        5-member team to deliver a large-scale project within 1
                        week.
                      </li>
                    </ul>
                  </div>
        ...
        <section id="experience">
          <section class="mx-auto p-10">
            <h1 class="font-black text-4xl mb-12 text-center">
              ...
              <div class="space-y-12 relative">
                ...
                <div class="md:flex md:items-start md:space-x-8 relative z-10">
                  ...
                  <div class="md:w-11/12">
                    ...
                    <p class="text-sm text-gray-500 mb-3">
                      I2E Consulting | Sep 2023 - Present
                    </p>
                    <ul class="list-disc list-inside text-gray-700 space-y-2 text-sm">
                      <li>
                        Developed responsive email templates with HTML/CSS and
                        automated dispatch via Cron Jobs.
                      </li>
                      <li>
                        Optimized backend APIs with pagination, indexing, and
                        caching for enhanced performance.
                      </li>
                      <li>
                        Managed deployments on Virtual Machines ensuring zero
                        downtime.
                      </li>
                      <li>
                        Integrated payment gateways (Stripe & PayPal) for
                        seamless payment processing.
                      </li>
                      <li>
                        Led database migration from MySQL to PostgreSQL with
                        schema optimization.
                      </li>
                      <li>
                        Played key role in chatbot development with Azure Blob
                        Storage integration.
                      </li>
                    </ul>
                  </div>
                ...
                <div class="md:flex md:items-start md:space-x-8 relative z-10">
                  ...
                  <div class="md:w-11/12">
                    ...
                    <p class="text-sm text-gray-500 mb-3">
                      Greenify | May 2023 - Sep 2023
                    </p>
                    <ul class="list-disc list-inside text-gray-700 space-y-2 text-sm">
                      <li>
                        Thrived as a full-stack developer, bridging frontend and
                        backend development.
                      </li>
                      <li>
                        Delivered innovative dynamic solutions aligned with
                        business goals.
                      </li>
                    </ul>
                  </div>
                ...
                <div class="md:flex md:items-start md:space-x-8 relative z-10">
                  ...
                  <div class="md:w-11/12">
                    ...
                    <p class="text-sm text-gray-500 mb-3">
                      Razorlabz | Sep 2020 - May 2023
                    </p>
                    <ul class="list-disc list-inside text-gray-700 space-y-2 text-sm">
                      <li>
                        Led backend development integrating Twitter and LinkedIn
                        APIs & Swagger docs.
                      </li>
                      <li>
                        Engineered content curation features optimizing API
                        calls and user engagement.
                      </li>
                      <li>
                        Collaborated with frontend teams to deliver cohesive UI
                        despite backend focus.
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="min-h-screen flex flex-col md:flex-row">
              ...
              <div class="w-full md:w-1/2 bg-gray-200 p-10 flex flex-col justify-center max-w-md mx-auto space-y-12">
                ...
                <form class="space-y-6" action="#" method="POST" novalidate>
                  <div>
                    <label for="name" class="block mb-1 font-semibold text-sm">
                      Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label for="email" class="block mb-1 font-semibold text-sm">
                      Email
                    </label>
                    <input
                      type="email"
                ...
                <div class="pt-8 border-t border-gray-200">
                  ...
                  <div class="flex flex-col space-y-4 text-gray-700 text-sm">
                    <a
                      href="https://github.com/sainath47"
                      target="_blank"
                      rel="noreferrer"
                    ...
                    >
                      ...
                      <span>
                        LinkedIn: linkedin.com/in/sainath-reddy-4444a7234
                      </span>
                    </a>
                    <a
                      href="mailto:p.v.sainathreddy@hotmail.com"
                      class="flex items-center gap-3 hover:text-red-600 transition"
                    >
                      <i class="fas fa-envelope text-2xl text-red-600"></i>
                      <span>Email: p.v.sainathreddy@hotmail.com</span>
                    </a>
                    <a
                      href="tel:+918826474768"
